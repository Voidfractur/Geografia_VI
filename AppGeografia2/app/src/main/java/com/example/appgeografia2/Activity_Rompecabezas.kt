...
import kotlinx.android.synthetic.main.activity__rompecabezas.*

class Activity_Rompecabezas : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity__rompecabezas)
        ...
        ivMexico.setOnLongClickListener(longClickListener)
        ivItalia.setOnLongClickListener(longClickListener)
        ivPeru.setOnLongClickListener(longClickListener)
        ...
        tivMexico.setOnDragListener(dragListener)
        tivItalia.setOnDragListener(dragListener)
        tivPeru.setOnDragListener(dragListener)
    }
    ...
    private val dragListener = View.OnDragListener { v, event ->
        ...
        when (event.action) {
            DragEvent.ACTION_DRAG_STARTED -> {
                statusTextView.text = "Estas arrastrando un nombre"
                true
            }
